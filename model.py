            ...
            with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.separable_conv2d],
                ...
                with slim.arg_scope([ops.expanded_conv],**expand_kwargs):
                    with slim.arg_scope([slim.conv2d, slim.separable_conv2d],padding='SAME'):
                        x = unpool(end_points['pool5'])
                        x = tf.concat([x,end_points['pool4']],axis=-1)
                        x = ops.expanded_conv(x, 96,depthwise_location='input',expansion_size= expand_input(1,divisible_by=1))
            ...
            with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.separable_conv2d],
                ...
                with slim.arg_scope([ops.expanded_conv],**expand_kwargs):
                    with slim.arg_scope([slim.conv2d, slim.separable_conv2d],padding='SAME'):
                        x = unpool(end_points['pool5'])
                        x = tf.concat([x,end_points['pool4']],axis=-1)
                        x = ops.expanded_conv(x, 64,depthwise_location='input',expansion_size= expand_input(1,divisible_by=1))
            ...
            with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.separable_conv2d],
                ...
                with slim.arg_scope([ops.expanded_conv],**expand_kwargs):
                    with slim.arg_scope([slim.conv2d, slim.separable_conv2d],padding='SAME'):
                        x = unpool(end_points['pool5'])
                        x = tf.concat([x,end_points['pool4']],axis=-1)
                        x = ops.expanded_conv(x, 160,expansion_size= expand_input(1,divisible_by=1))
                        print("up_4 shape : ",x.shape)

                        x = unpool(x)
                        x = tf.concat([x,end_points['pool3']],axis=-1)
                        x = ops.expanded_conv(x, 64)
                        print("up_3 shape : ",x.shape)
            ...
            with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.separable_conv2d],
                ...
                with slim.arg_scope([ops.expanded_conv],**expand_kwargs):
                    with slim.arg_scope([slim.conv2d, slim.separable_conv2d],padding='SAME'):
                        x = unpool(end_points['pool5'])
                        x = tf.concat([x,end_points['pool4']],axis=-1)
                        x = ops.expanded_conv(x, 48,expansion_size= expand_input(1,divisible_by=1))
                        x = slim.conv2d(x, 512, 3)
                        x = slim.conv2d(x, 64, 1)
                        print("up_4 shape : ",x.shape)
            ...
            with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.separable_conv2d],
                ...
                with slim.arg_scope([ops.expanded_conv],**expand_kwargs):
                    with slim.arg_scope([slim.conv2d, slim.separable_conv2d],padding='SAME'):
                        x = unpool(end_points['pool5'])
                        x = tf.concat([x,end_points['pool4']],axis=-1)
                        x = ops.expanded_conv(x, 160,depthwise_location='input',expansion_size= expand_input(1,divisible_by=1))
                        print("up_4 shape : ",x.shape)
